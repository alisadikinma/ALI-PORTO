...
<section id="awards" class="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 py-12">
    ...
    <div class="max-w-6xl mx-auto mt-8">
        ...
        <div class="pt-12"> <!-- Added explicit padding top -->
...
<section id="services" class="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
    ...
    <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
        <!-- Left Side - Service Cards (40%) -->
        <div class="lg:w-2/5 xl:w-2/5 service-left-panel flex flex-col">
        ...
        <div class="lg:w-3/5 xl:w-3/5 service-right-panel flex flex-col pr-4">
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ALI-PORTO\resources\views/welcome.blade.php ENDPATH**/ ?>