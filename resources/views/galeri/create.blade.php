                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_galeri"
                                           ...
                                           name="nama_galeri" value="{{ old('nama_galeri') }}" required>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="deskripsi_galeri" id="editor" class="form-control" rows="6" placeholder="Deskripsi galeri...">{{ old('deskripsi_galeri') }}</textarea>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="id_award" class="form-control">
                                        ...
                                        @foreach($awards as $award)
                                            <option value="{{ $award->id_award }}" {{ old('id_award') == $award->id_award ? 'selected' : '' }}>
                                                {{ $award->nama_award }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control" name="sequence" value="{{ old('sequence', 0) }}" min="0">
