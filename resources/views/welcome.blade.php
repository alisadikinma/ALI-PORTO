...
<section id="contact"
    ...
    <div class="flex flex-col gap-6 sm:gap-8 max-w-full lg:max-w-md">
        ...
        <div class="flex flex-col gap-4 sm:gap-6">
            <div
                class="flex items-center gap-4 p-3 sm:p-4 bg-slate-900 rounded-xl hover:bg-slate-700 transition-all duration-300">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <a href="tel:{{ $konf->no_hp_setting }}"
                        class="text-white text-base font-normal leading-normal hover:text-yellow-400 transition-colors">{{ $konf->no_hp_setting }}</a>
                </div>
            </div>
            <div
                class="flex items-center gap-4 p-3 sm:p-4 bg-slate-900 rounded-xl hover:bg-slate-700 transition-all duration-300">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <a href="mailto:{{ $konf->email_setting }}"
                        class="text-white text-base font-normal leading-normal hover:text-yellow-400 transition-colors">{{ $konf->email_setting }}</a>
                </div>
            </div>
            <div
                class="flex items-center gap-4 p-3 sm:p-4 bg-slate-900 rounded-xl hover:bg-slate-700 transition-all duration-300">
